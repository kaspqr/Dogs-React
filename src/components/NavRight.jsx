    ...
    return (
      <span className="nav-right-span">
        {(isAdmin || isSuperAdmin) && (
          <span>
            <Link className="header-link header-hover" to={"/adminpage"}>
        ...
        <Link className="header-link header-hover" to={"/conversations"}>
          <FontAwesomeIcon icon={faComments} />
        </Link>
        <Link className="header-link header-hover" to={`/users/${userId}`}>
          <FontAwesomeIcon icon={faUser} />
        </Link>
        <span className="header-link header-hover" onClick={onLogoutClicked}>
